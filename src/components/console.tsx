...
export function Console({ consoleOutputs, setConsoleOutputs }: ConsoleProps) {
  ...
  return consoleOutputs.length > 0 ? (
    <>
      ...
      <div
        className={cn(
          'fixed bottom-0 z-40 flex w-full flex-col overflow-x-hidden overflow-y-scroll border-t bg-muted border-border',
          {
        ...
        style={{ height }}
      >
        <div className="sticky top-0 z-50 flex h-fit w-full flex-row items-center justify-between border-b bg-muted px-2 py-1 border-border">
          ...
          <Button
            className="size-fit p-1 hover:bg-muted-foreground/10"
        ...
        <div>
          {consoleOutputs.map((consoleOutput, index) => (
            <div
              className="flex flex-row border-b bg-muted px-4 py-2 font-mono text-sm border-border"
